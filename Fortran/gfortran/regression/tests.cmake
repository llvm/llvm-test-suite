...
compile;addressing-modes_1.f90;;-w -Ofast;aarch64-.+-.+;
compile;addressing-modes_2.f90;;-w -Ofast -fdump-tree-ivopts-all;aarch64-.+-.+;
...
compile;allocatable_length.f90;;-Werror -Wall;;
...
compile;allocate_with_source_29.f90;xfail;-std=f2008;;
...
compile;array_memset_3.f90;;-O2 -fdump-tree-original;;
...
compile;associate_69.f90;;-Og -Wuninitialized -Wmaybe-uninitialized -fdump-tree-optimized;;
compile;associate_72.f90;;-fdump-tree-original;;
...
compile;bind_c_char_11.f90;;-Wuninitialized;;
...
compile;bounds_check_24.f90;;-fcheck=bounds -fdump-tree-original;;
compile;bounds_check_26.f90;;-fcheck=bounds -fdump-tree-original;;
compile;bounds_check_3.f90;;;;
compile;bounds_check_array_ctor_3.f90;xfail;;;
compile;bounds_check_array_ctor_5.f90;xfail;;;
compile;bounds_check_fail_8.f90;;-fcheck=bounds -g -fdump-tree-original;;
compile;bounds_check_strlen_10.f90;;-fcheck=bounds -fdump-tree-optimized;;
...
compile;char_array_constructor_5.f90;;-std=gnu;;
...
compile;class_76.f90;;-fdump-tree-original;;
compile;class_77.f90;;-fdump-tree-original;;
...
compile;coarray_critical_2.f90;xfail;-fcoarray=lib;;
...
compile;coarray_this_image_3.f90;xfail;-fcoarray=lib;;
...
compile;continuation_18.f90;;-std=f2023;;
...
compile;data_bounds_1.f90;xfail;-std=gnu -w;;
...
compile;data_initialized_4.f90;;-std=legacy;;
...
compile;derived_result_4.f90;;-Wall -Wno-return-type -Wno-unused-variable;;
...
compile;diagnostic-format-json-pr105916.F90;;-fdiagnostics-format=json-stderr -fmax-errors=1 -Wfatal-errors;;
compile;diagnostic-format-sarif-1.F90;xfail;-fdiagnostics-format=sarif-file;;
compile;diagnostic-format-sarif-pr105916.f90;;-fdiagnostics-format=sarif-file -fmax-errors=1 -Wfatal-errors;;
...
compile;do_concurrent_7.f90;;-fdump-tree-original;;
compile;do_concurrent_8_f2018.f90;xfail;-std=f2018;;
compile;do_concurrent_8_f2023.f90;xfail;-std=gnu;;
compile;do_concurrent_9.f90;xfail;-std=f2018;;
compile;do_concurrent_all_clauses.f90;xfail;;;
compile;do_concurrent_constraints.f90;xfail;-fcoarray=single;;
compile;do_concurrent_local_init.f90;;-fmax-errors=1;;
compile;do_concurrent_locality_specs.f90;;-Wunused-variable;;
...
compile;finalize_57.f90;;-fdump-tree-original;;
...
compile;findloc_9.f90;;-fdump-tree-original;;
...
compile;interface_procedure_1.f90;xfail;-std=f95;;
...
compile;line_length_10.f90;;-std=f2018 -Wno-line-truncation;;
compile;line_length_11.f90;;-Wno-all -std=f2018;;
compile;line_length_12.f90;xfail;-std=f2018;;
compile;line_length_13.f90;xfail;-std=f2023;;
compile;line_length_2.f90;;-ffree-line-length-none -std=f2018;;
...
compile;line_length_5.f90;xfail;-std=f2018 -Wline-truncation;;
compile;line_length_6.f90;xfail;-std=f2018;;
compile;line_length_7.f90;;-std=f2018 -Wno-error;;
compile;line_length_8.f90;xfail;-std=f2018 -Wline-truncation;;
compile;line_length_9.f90;xfail;-std=f2018 -Wall;;
...
compile;minmaxloc_18.f90;;-O -fdump-tree-original;;
compile;minmaxloc_18a.f90;;-Os -fdump-tree-original;;
compile;minmaxloc_18b.f90;;-O2 -fno-inline-intrinsics=minloc -fdump-tree-original;;
compile;minmaxloc_18c.f90;;-O3 -fno-inline-intrinsics=maxloc -fdump-tree-original;;
compile;minmaxloc_18d.f90;;-O0 -finline-intrinsics=maxloc -fdump-tree-original;;
compile;minmaxloc_19.f90;;-O -fdump-tree-original;;
compile;minmaxloc_20.f90;;-O -fdump-tree-original;;
compile;minmaxloc_21.f90;;-O -fdump-tree-original;;
...
compile;pointer_init_13.f90;;-fcheck=pointer -fdump-tree-optimized -O -fno-inline;;
...
compile;pr100988.f90;;-fdump-tree-original;;
...
compile;pr102532.f90;xfail;-fcoarray=single;;
...
compile;pr108889.f90;;-Wall -fdump-tree-original;;
compile;pr109209.f90;;;;
compile;pr109265.f90;;-O3 -w;;
compile;pr109948.f90;;;;
compile;pr110221.f;;-O2 -w;;
...
compile;pr112406.f90;;-Ofast -w -fprofile-generate;;
compile;pr112407b.f90;;-std=f2008;;
compile;pr112459.f90;;-w -fdump-tree-original;;
compile;pr112877-1.f90;;-Os;;
compile;PR113061.f90;;-fno-move-loop-invariants -Oz;;
compile;pr113503_1.f90;;-O2 -fno-inline -Wuninitialized;;
...
compile;pr114883.f90;;-O2 -fvect-cost-model=cheap;;
compile;pr114959.f90;;-fdump-tree-original;;
compile;pr115281.f90;;-O3;;
compile;pr115348.f90;;-fcheck=recursion;;
compile;pr117060.f90;;-O2;;
compile;pr117763.f90;;-fdump-tree-original;;
...
compile;pr25623-2.f90;;-fdump-tree-optimized-blocks-details -O3;;
compile;pr25623.f90;;-fdump-tree-optimized-blocks-details -O2;;
...
compile;pr43984.f90;;-O2 -fno-tree-dominator-opts -fdump-tree-pre -fno-tree-sra;;
...
compile;pr67616.f90;;;;
compile;pr67740.f90;;-fdump-tree-original;;
...
compile;pr89462.f90;;-pedantic-errors;;
...
compile;pr95398.f90;xfail;-std=f2008;;
...
compile;pr99139.f90;;-finit-local-zero;;
...
compile;proc_ptr_56.f90;xfail;-std=f2003;;
compile;proc_ptr_57.f90;;-fcheck=pointer;;
...
compile;repeat_8.f90;;-Wconversion-extra;;
compile;reshape_10.f90;;-fmax-array-constructor=65536 -fdump-tree-original;;
compile;reshape_11.f90;xfail;-fmax-array-constructor=65536;;
...
compile;statement_function_5.f90;;-std=legacy -fdump-tree-optimized;;
...
compile;system_clock_4.f90;xfail;-std=f2023;;
compile;tab_continuation.f;xfail;;;
compile;team_change_2.f90;xfail;-fcoarray=lib;;
compile;team_end_2.f90;xfail;-fcoarray=lib;;
compile;team_form_2.f90;xfail;-fcoarray=lib;;
compile;team_get_1.f90;;-fcoarray=lib -fdump-tree-original;;
compile;team_sync_1.f90;xfail;-fcoarray=lib;;
...
compile;uncommon_block_data_2.f90;;-Wunused-variable;;
...
compile;zero_sized_13.f90;xfail;-w;;
...
run;actual_array_subref.f90;;-O2 -fcheck=bounds;;
...
run;allocatable_char_1.f90;;-fdump-tree-original;;
...
run;allocate_with_source_30.f90;xfail;-std=f2008 -fcheck=bounds -g -fdump-tree-original;;
run;allocate_with_source_31.f90;;-std=gnu -fcheck=no-bounds;;
...
run;associate_64.f90;;-fdump-tree-original;;
run;associate_65.f90;;;;
run;associate_66.f90;;-fdump-tree-original;;
run;associate_67.f90;;;;
run;associate_68.f90;;;;
run;associate_7.f03;;-std=f2003;;
run;associate_70.f90;;-Wuninitialized;;
...
run;assumed_rank_25.f90;;-fcheck=bounds;;
...
run;bounds_check_25.f90;;-fcheck=bounds -fdump-tree-original;;
run;bounds_check_27.f90;;-fcheck=bounds;;
...
run;bounds_check_array_io.f90;;-fcheck=bounds -fdump-tree-original;;
...
run;coarray_critical_3.f90;;-fcoarray=lib -fdump-tree-original -lcaf_single;;
...
run;coarray_this_image_1.f90;;-fdump-tree-original -fcoarray=single;;
run;coarray_this_image_2.f90;;-fdump-tree-original -fcoarray=lib -lcaf_single;;
run;coindexed_1.f90;;-fcoarray=lib -lcaf_single;;
run;com_block_driver.f90;;;;
run;comma.f;;;;
run;comma_format_extension_3.f;;;;
run;comma_format_extension_4.f;;-std=legacy;;
run;common_2.f90;;;;
run;common_4.f90;;-w;;
...
run;contiguous_15.f90;;-fdump-tree-original;;
...
run;continuation_19.f;;-std=f2023;;
...
run;cray_pointers_13.f90;;-fcray-pointer;;
...
run;do_concurrent_11.f90;;-fdump-tree-original;;
run;do_concurrent_13.f90;;-fdump-tree-original;;
...
run;dollar_edit_descriptor_2.f;;-w -std=legacy;;
...
run;finalize_60.f90;;;;
run;finalize_8.f03;;;;
run;findloc_10.f90;;-fdump-tree-original;;
run;findloc_2.f90;;;;
run;findloc_3.f90;;;;
run;findloc_4.f90;;;;
run;findloc_5.f90;;;;
...
run;implied_do_io_8.f90;;-fcheck=bounds;;
...
run;interface_55.f90;;-Wexternal-argument-mismatch;;
run;interface_56.f90;;-Wall;;
...
run;null_4.f90;;;;
run;null_9.f90;;;;
run;null_actual_6.f90;;-fcheck=bounds;;
run;null_actual_7.f90;;-fcheck=bounds;;
...
run;optional_absent_12.f90;;-fcheck=array-temps;;
...
run;pr109345.f90;;;;
run;pr109358.f90;;;;
run;pr109662-a.f90;;-std=f2003;;
run;pr109662.f90;;-std=f2003;;
run;pr110415.f90;;;;
run;pr111022.f90;;;;
run;pr112407a.f90;;;;
run;pr113363.f90;;;;
...
run;proc_ptr_5.f90;;;;
run;proc_ptr_51.f90;;;;
run;proc_ptr_52.f90;;-fcheck=pointer;;
run;proc_ptr_6.f90;;;;
...
run;size_optional_dim_2.f90;;-fdump-tree-original;;
run;sizeof.f90;;;;
run;sizeof_4.f90;;;;
run;sizeof_6.f90;;;;
run;slash_1.f90;;;;
...
run;streamio_7.f90;;;;
run;streamio_8.f90;;;;
run;streamio_9.f90;;-ffloat-store;;
...
run;system_clock_1.f90;;-std=f2003;;
run;system_clock_3.f08;;-std=f2008;;
run;t_editing.f;;;;
run;team_change_1.f90;;-fcoarray=single;;
run;team_change_3.f90;;-fcoarray=lib -fdump-tree-original -lcaf_single;;
run;team_end_1.f90;;-fcoarray=single;;
run;team_end_3.f90;;-fcoarray=lib -fdump-tree-original -lcaf_single;;
run;team_form_1.f90;;-fcoarray=single;;
run;team_form_3.f90;;-fcoarray=lib -fdump-tree-original -lcaf_single;;
run;team_number_1.f90;;-fcoarray=single;;
run;team_sync_2.f90;;-fcoarray=lib -fdump-tree-original -lcaf_single;;
run;temporary_1.f90;;;;
run;temporary_3.f90;;;;
