...
compile;id-19.f;;;;
compile;id-2.f90;;;;
compile;id-20.f;;-O3 -ffast-math;;
compile;id-21.f;;;;
compile;id-22.f;;-O3 -ffast-math;;
compile;id-23.f;;;;
compile;id-24.f;;;;
compile;id-25.f;;;;
compile;id-26.f03;;-floop-nest-optimize;;
compile;id-27.f90;;-Ofast;;
compile;id-28.f90;;;;
compile;id-3.f90;;;;
compile;id-4.f90;;;;
compile;id-5.f;;;;
...
compile;id-pr46994.f90;;-O -ffast-math -fgraphite-identity;;
compile;id-pr46995.f90;;-O -ffast-math -fgraphite-identity;;
compile;id-pr47691.f;;-O -fgraphite-identity -ffast-math;;
compile;interchange-1.f;;;;
compile;interchange-2.f;;;;
compile;interchange-3.f90;;;;
compile;interchange-4.f;;;;
compile;interchange-5.f;;;;
compile;pr107865.f90;;-O1 -floop-parallelize-all;;
compile;pr14741.f90;;-O3 -ffast-math -floop-nest-optimize -floop-block;;
compile;pr29290.f90;;-O3;;
compile;pr36286.f90;;-O1;;
compile;pr36922.f;;-O2;;
...
compile;pr42326-1.f90;;-O2 -floop-parallelize-all;i.86-.+-.+ x86_64-.+-.+;
compile;pr42326.f90;;-O2 -floop-strip-mine;i.86-.+-.+ x86_64-.+-.+;
compile;pr42334-1.f;;-O2 -floop-nest-optimize;;
compile;pr42334.f90;;-O2 -floop-nest-optimize;;
...
compile;pr47019.f;;-O -fgraphite-identity;;
...
compile;pr68279.f90;;-floop-nest-optimize -O2;;
...
compile;pr68550-2.f90;;-floop-nest-optimize -O1;;
...
compile;pr82449.f;;-O2 -floop-nest-optimize;;
...
compile;pr84223.f90;;-fgraphite-identity -O1 sccvn-max-alias-queries-per-access=0;;
compile;pr89182.f90;;-O3 -fgraphite-identity max-completely-peeled-insns=8;;
compile;pr90240.f;;-O1 -floop-nest-optimize;;
compile;pr93439.f90;;-O2 -floop-parallelize-all -floop-unroll-and-jam;;
compile;run-id-1.f;;;;
compile;run-id-2.f90;;;;
compile;scop-1.f;;;;
compile;vect-pr40979.f90;;;;
compile;vect-pr94043.f90;;-O3;;
run;pr29581.f90;;;;
run;pr29832.f90;;;;
run;pr68565.f90;;-floop-nest-optimize;;
run;run-id-3.f90;;-floop-nest-optimize;;