...
44100   FORMAT(" ", / " INQF4 - (441) INQUIRE BY FILE" //               01440921
     1         " DIRECT ACCESS UNFORMATTED FILE" //                     01450921
     2         " ANS REF. - 12.10.3" )                                  01460921
...
20015      FORMAT (" ",2X,I3,4X," FAIL",12X,                            01820921
     1     "ERROR IN EXECUTION OF INQUIRE STATEMENT (ERR=)" /)          01830921
           GO TO 20016                                                  01840921
20010      CONTINUE                                                     01850921
           WRITE (NUVI, 20011) IVTNUM                                   01860921
20011      FORMAT(" ",2X,I3,4X," FAIL",12X,                             01870921
     1     "ERROR IN AN INQUIRE SPECIFIER" /)                           01880921
20016      IVFAIL = IVFAIL + 1                                          01890921
           WRITE (NUVI, 20012) IVI,AVB,BVB,JVI,B10VK,D10VK,KVI,         01900921
     1                         LVI,E11VK,G10VK                          01910921
20012      FORMAT (" ",16X,"COMPUTED: " ,"IOSTAT=",I1,", EXIST=",L1,    01920921
     1             " ,OPENED=",L1,", NUMBER=",I4,","/                   01930921
     2             " ",26X,"ACCESS=",A6,", DIRECT=",A3,", RECL=",       01940921
     3             I4,","/" ",26X,"NEXTREC=",I4,", FORM=",              01950921
     4             A11,","/" ",26X,"UNFORMATTED=" ,A3)                  01960921
           WRITE (NUVI, 20013) IOVI,MVI                                 01970921
20013      FORMAT (" ",16X,"CORRECT:  " ,"IOSTAT=0, EXIST=T, " ,        01980921
     1             "OPENED=T, NUMBER=" ,I4,","/                         01990921
     2             " ",26X,"ACCESS=DIRECT, DIRECT=YES, RECL=" ,         02000921
     3             I4,","/" ",26X,"NEXTREC=   1, FORM=UNFORMATTED," /   02010921
     4             " ",26X,"UNFORMATTED=YES" )                          02020921
...
20025      FORMAT (" ",2X,I3,4X," FAIL",12X,                            02240921
     1     "ERROR IN EXECUTION OF INQUIRE STATEMENT (ERR=)" /)          02250921
           GO TO 20026                                                  02260921
20020      CONTINUE                                                     02270921
           WRITE (NUVI, 20021) IVTNUM                                   02280921
20021      FORMAT(" ",2X,I3,4X," FAIL",12X,                             02290921
     1     "ERROR IN AN INQUIRE SPECIFIER" /)                           02300921
20026      IVFAIL = IVFAIL + 1                                          02310921
           WRITE (NUVI, 20022) IVI,D10VK,KVI,LVI                        02320921
20022      FORMAT (" ",16X,"COMPUTED: " ,"IOSTAT=",I1,", DIRECT=",A3,   02330921
     1             " ,RECL=",I4,", NEXTREC=" ,I4)                       02340921
           WRITE (NUVI, 20023) MVI                                      02350921
20023      FORMAT (" ",16X,"CORRECT:  " ,"IOSTAT=0, DIRECT=YES" ,       02360921
     1             " ,RECL=",I4,", NEXTREC=   2" )                      02370921
...
20035      FORMAT (" ",2X,I3,4X," FAIL",12X,                            02590921
     1     "ERROR IN EXECUTION OF INQUIRE STATEMENT (ERR=)" /)          02600921
           GO TO 20036                                                  02610921
20030      CONTINUE                                                     02620921
           WRITE (NUVI, 20031) IVTNUM                                   02630921
20031      FORMAT(" ",2X,I3,4X," FAIL",12X,                             02640921
     1     "ERROR IN AN INQUIRE SPECIFIER" /)                           02650921
20036      IVFAIL = IVFAIL + 1                                          02660921
           WRITE (NUVI, 20032) IVI,D10VK,KVI,LVI                        02670921
20032      FORMAT (" ",16X,"COMPUTED: " ,"IOSTAT=",I1,", DIRECT=",A3,   02680921
     1             " ,RECL=",I4,", NEXTREC=" ,I4)                       02690921
           WRITE (NUVI, 20033) MVI                                      02700921
20033      FORMAT (" ",16X,"CORRECT:  " ,"IOSTAT=0, DIRECT=YES" ,       02710921
     1             " ,RECL=",I4,", NEXTREC=   2" )                      02720921
...
C****                                                                   02990921
80000 FORMAT (" ",2X,I3,4X,"DELETED",32X,A31)                           03000921
80002 FORMAT (" ",2X,I3,4X," PASS  ",32X,A31)                           03010921
80004 FORMAT (" ",2X,I3,4X,"INSPECT",32X,A31)                           03020921
80008 FORMAT (" ",2X,I3,4X," FAIL  ",32X,A31)                           03030921
80010 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",15X,"COMPUTED= " ,           03040921
     1I6,/," ",15X,"CORRECT=  " ,I6)                                    03050921
80012 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           03060921
     1E12.5,/," ",16X,"CORRECT=  " ,E12.5)                              03070921
80018 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           03080921
     1A21,/," ",16X,"CORRECT=  " ,A21)                                  03090921
80020 FORMAT (" ",16X,"COMPUTED= " ,A21,1X,A31)                         03100921
80022 FORMAT (" ",16X,"CORRECT=  " ,A21,1X,A31)                         03110921
80024 FORMAT (" ",16X,"COMPUTED= " ,I6,16X,A31)                         03120921
80026 FORMAT (" ",16X,"CORRECT=  " ,I6,16X,A31)                         03130921
80028 FORMAT (" ",16X,"COMPUTED= " ,E12.5,10X,A31)                      03140921
80030 FORMAT (" ",16X,"CORRECT=  " ,E12.5,10X,A31)                      03150921
80050 FORMAT (" ",48X,A31)                                              03160921
CBE** ********************** BBCFMT0A **********************************03170921
CBB** ********************** BBCFMT0B **********************************03180921
C**** FORMAT STATEMENTS FOR PAGE HEADERS                                03190921
C****                                                                   03200921
90002 FORMAT ("1")                                                      03210921
90004 FORMAT (" ")                                                      03220921
90006 FORMAT (" ",20X,"NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY" )03230921
90007 FORMAT (" ",19X,"FORTRAN COMPILER VALIDATION SYSTEM" )            03240921
90008 FORMAT (" ",21X,A13,A17)                                          03250921
90009 FORMAT (" ",/," *",A5,"BEGIN*",12X,"TEST RESULTS - " ,A5,/)       03260921
90010 FORMAT (" ",8X,"TEST DATE*TIME= " ,A17,"  -  COMPILER= " ,A20)    03270921
90013 FORMAT (" "," TEST   ","PASS/FAIL " ,6X,"DISPLAYED RESULTS" ,     03280921
     1       7X,"REMARKS",24X)                                          03290921
90014 FORMAT (" ","----------------------------------------------" ,    03300921
     1        "---------------------------------" )                     03310921
90015 FORMAT (" ",48X,"THIS PROGRAM HAS " ,I3," TESTS",/)               03320921
C****                                                                   03330921
C**** FORMAT STATEMENTS FOR REPORT FOOTINGS                             03340921
C****                                                                   03350921
90016 FORMAT (" ",/," *",A5,"END*",14X,"END OF TEST - " ,A5,/)          03360921
90018 FORMAT (" ",A13,13X,A20,"   *   ",A10,"/",                        03370921
     1        A13)                                                      03380921
90019 FORMAT (" ","FOR OFFICIAL USE ONLY     " ,35X,"COPYRIGHT  1982" ) 03390921
C****                                                                   03400921
C**** FORMAT STATEMENTS FOR RUN SUMMARY                                 03410921
C****                                                                   03420921
90020 FORMAT (" ",21X,I5," TESTS PASSED" )                              03430921
90022 FORMAT (" ",21X,I5," TESTS FAILED" )                              03440921
90024 FORMAT (" ",21X,I5," TESTS DELETED" )                             03450921
90026 FORMAT (" ",21X,I5," TESTS REQUIRE INSPECTION" )                  03460921
90028 FORMAT (" ",21X,I5," OF ",I3," TESTS EXECUTED" )                  03470921
