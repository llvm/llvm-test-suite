...
15501   FORMAT (" ", // 1X,"YDINT - (155) INTRINSIC FUNCTIONS--" //16X, 01010801
     1          "DINT, DNINT, IDNINT (TYPE CONVERSION) "  //            01020801
     2          "  ANS REF. - 15.3" )                                   01030801
...
15502   FORMAT(// 8X, "TEST OF DINT" )                                  01170801
...
15504   FORMAT( // 8X, "TEST OF DNINT" )                                02690801
...
15506   FORMAT( // 8X, "TEST OF IDNINT" )                               05010801
...
C****                                                                   07300801
80000 FORMAT (" ",2X,I3,4X,"DELETED",32X,A31)                           07310801
80002 FORMAT (" ",2X,I3,4X," PASS  ",32X,A31)                           07320801
80004 FORMAT (" ",2X,I3,4X,"INSPECT",32X,A31)                           07330801
80008 FORMAT (" ",2X,I3,4X," FAIL  ",32X,A31)                           07340801
80010 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",15X,"COMPUTED= " ,           07350801
     1I6,/," ",15X,"CORRECT=  " ,I6)                                    07360801
80012 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           07370801
     1E12.5,/," ",16X,"CORRECT=  " ,E12.5)                              07380801
80018 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           07390801
     1A21,/," ",16X,"CORRECT=  " ,A21)                                  07400801
80020 FORMAT (" ",16X,"COMPUTED= " ,A21,1X,A31)                         07410801
80022 FORMAT (" ",16X,"CORRECT=  " ,A21,1X,A31)                         07420801
80024 FORMAT (" ",16X,"COMPUTED= " ,I6,16X,A31)                         07430801
80026 FORMAT (" ",16X,"CORRECT=  " ,I6,16X,A31)                         07440801
80028 FORMAT (" ",16X,"COMPUTED= " ,E12.5,10X,A31)                      07450801
80030 FORMAT (" ",16X,"CORRECT=  " ,E12.5,10X,A31)                      07460801
80050 FORMAT (" ",48X,A31)                                              07470801
CBE** ********************** BBCFMT0A **********************************07480801
CBB** ********************** BBCFMAT1 **********************************07490801
C**** FORMATS FOR TEST DETAIL LINES - FULL LANGUAGE                     07500801
C****                                                                   07510801
80031 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           07520801
     1D17.10,/," ",16X,"CORRECT=  " ,D17.10)                            07530801
80033 FORMAT (" ",16X,"COMPUTED= " ,D17.10,10X,A31)                     07540801
80035 FORMAT (" ",16X,"CORRECT=  " ,D17.10,10X,A31)                     07550801
80037 FORMAT (" ",16X,"COMPUTED= " ,"(",E12.5,", ",E12.5,")",6X,A31)    07560801
80039 FORMAT (" ",16X,"CORRECT=  " ,"(",E12.5,", ",E12.5,")",6X,A31)    07570801
80041 FORMAT (" ",16X,"COMPUTED= " ,"(",F12.5,", ",F12.5,")",6X,A31)    07580801
80043 FORMAT (" ",16X,"CORRECT=  " ,"(",F12.5,", ",F12.5,")",6X,A31)    07590801
80045 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           07600801
     1"(",F12.5,", ",F12.5,")"/," ",16X,"CORRECT=  " ,                  07610801
     2"(",F12.5,", ",F12.5,")")                                         07620801
CBE** ********************** BBCFMAT1 **********************************07630801
CBB** ********************** BBCFMT0B **********************************07640801
C**** FORMAT STATEMENTS FOR PAGE HEADERS                                07650801
C****                                                                   07660801
90002 FORMAT ("1")                                                      07670801
90004 FORMAT (" ")                                                      07680801
90006 FORMAT (" ",20X,"NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY" )07690801
90007 FORMAT (" ",19X,"FORTRAN COMPILER VALIDATION SYSTEM" )            07700801
90008 FORMAT (" ",21X,A13,A17)                                          07710801
90009 FORMAT (" ",/," *",A5,"BEGIN*",12X,"TEST RESULTS - " ,A5,/)       07720801
90010 FORMAT (" ",8X,"TEST DATE*TIME= " ,A17,"  -  COMPILER= " ,A20)    07730801
90013 FORMAT (" "," TEST   ","PASS/FAIL " ,6X,"DISPLAYED RESULTS" ,     07740801
     1       7X,"REMARKS",24X)                                          07750801
90014 FORMAT (" ","----------------------------------------------" ,    07760801
     1        "---------------------------------" )                     07770801
90015 FORMAT (" ",48X,"THIS PROGRAM HAS " ,I3," TESTS",/)               07780801
C****                                                                   07790801
C**** FORMAT STATEMENTS FOR REPORT FOOTINGS                             07800801
C****                                                                   07810801
90016 FORMAT (" ",/," *",A5,"END*",14X,"END OF TEST - " ,A5,/)          07820801
90018 FORMAT (" ",A13,13X,A20,"   *   ",A10,"/",                        07830801
     1        A13)                                                      07840801
90019 FORMAT (" ","FOR OFFICIAL USE ONLY     " ,35X,"COPYRIGHT  1982" ) 07850801
C****                                                                   07860801
C**** FORMAT STATEMENTS FOR RUN SUMMARY                                 07870801
C****                                                                   07880801
90020 FORMAT (" ",21X,I5," TESTS PASSED" )                              07890801
90022 FORMAT (" ",21X,I5," TESTS FAILED" )                              07900801
90024 FORMAT (" ",21X,I5," TESTS DELETED" )                             07910801
90026 FORMAT (" ",21X,I5," TESTS REQUIRE INSPECTION" )                  07920801
90028 FORMAT (" ",21X,I5," OF ",I3," TESTS EXECUTED" )                  07930801
