...
C                                                                       09000205
      ...
      STOP                                                              09090205
90001 FORMAT (" ",24X,"FM205")                                          09100205
90000 FORMAT (" ",20X,"END OF PROGRAM FM205" )                          09110205
C                                                                       09120205
C     FORMATS FOR TEST DETAIL LINES                                     09130205
C                                                                       09140205
80000 FORMAT (" ",4X,I5,6X,"DELETED")                                   09150205
80002 FORMAT (" ",4X,I5,7X,"PASS")                                      09160205
80010 FORMAT (" ",4X,I5,7X,"FAIL",10X,I6,9X,I6)                         09170205
80012 FORMAT (" ",4X,I5,7X,"FAIL",4X,E12.5,3X,E12.5)                    09180205
80018 FORMAT (" ",4X,I5,7X,"FAIL",2X,A14,1X,A14)                        09190205
C                                                                       09200205
C     FORMAT STATEMENTS FOR PAGE HEADERS                                09210205
C                                                                       09220205
90002 FORMAT ("1")                                                      09230205
90004 FORMAT (" ")                                                      09240205
90006 FORMAT (" ",10X,"FORTRAN COMPILER VALIDATION SYSTEM" )            09250205
90008 FORMAT (" ",21X,"VERSION 2.1" )                                   09260205
90010 FORMAT (" ",8X,"FOR OFFICIAL USE ONLY - COPYRIGHT 1978" )         09270205
90012 FORMAT (" ",5X,"TEST",5X,"PASS/FAIL",5X,"COMPUTED",8X,"CORRECT")  09280205
90014 FORMAT (" ",5X,"----------------------------------------------" ) 09290205
90016 FORMAT (" ",18X,"SUBSET LEVEL TEST" )                             09300205
C                                                                       09310205
C     FORMAT STATEMENTS FOR RUN SUMMARY                                 09320205
C                                                                       09330205
90020 FORMAT (" ",19X,I5," TESTS FAILED" )                              09340205
90022 FORMAT (" ",19X,I5," TESTS PASSED" )                              09350205
90024 FORMAT (" ",19X,I5," TESTS DELETED" )                             09360205
      END                                                               09370205
