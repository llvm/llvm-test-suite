...
39300   FORMAT(" ",/ " INTER4 - (393) INTERNAL FILES --  USING WRITE"   01090909
     1        //" ANS. REF. - 12.2.5" )                                 01100909
...
39199   FORMAT (" ",48X,"NOTE 1: FOR NUMERIC VALUES,    " /             01210909
     1          " ",48X,"   OPTIONAL LEADING ZERO MAY BE" /             01220909
     2          " ",48X,"   BLANK FOR ABSOLUTE VALUE < 1" /             01230909
     3          " ",48X,"NOTE 2: LEADING PLUS SIGN IS   " /             01240909
     4          " ",48X,"   OPTIONAL FOR NUMERIC VALUES " /             01250909
     5          " ",48X,"NOTE 3: E FORMAT EXPONENT MAY  " /             01260909
     6          " ",48X,"   BE E+NN OR +0NN FOR REALS   " /             01270909
     7          " ",48X,"NOTE 4: D FORMAT EXPONENT MAY  " /             01280909
     8          " ",48X,"   BE D+NN, E+NN, OR +0NN FOR  " /             01290909
     9          " ",48X,"   DOUBLE PRECISION VALUES     " /)            01300909
C*****                                                                  01310909
...
70010      FORMAT(" ",16X,"COMPUTED: " ,54A1)                           01570909
           WRITE (NUVI, 70020) (A97E1(I), I= 55,97)                     01580909
70020      FORMAT(" ",26X,43A1)                                         01590909
           WRITE (NUVI, 70030) (A97E2(I), I = 1,54)                     01600909
70030      FORMAT(" ",16X,"CORRECT:  " ,54A1)                           01610909
           WRITE (NUVI, 70040) (A97E2(I), I= 55,97)                     01620909
70040      FORMAT(" ",26X,43A1)                                         01630909
...
70050      FORMAT(" ",16X,"COMPUTED: " ,43A1)                           02580909
70060      FORMAT(" ",16X,"CORRECT:  " ,43A1)                           02590909
...
70070      FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED: " ,      03160909
     1             A29,/," ",16X,"CORRECT:  " ,A29)                     03170909
...
70080      FORMAT (" ",16X,"COMPUTED: " , A29,/                         07510909
     1             " ",16X,"CORRECT:  " ,A29)                           07520909
...
C****                                                                   08250909
80000 FORMAT (" ",2X,I3,4X,"DELETED",32X,A31)                           08260909
80002 FORMAT (" ",2X,I3,4X," PASS  ",32X,A31)                           08270909
80004 FORMAT (" ",2X,I3,4X,"INSPECT",32X,A31)                           08280909
80008 FORMAT (" ",2X,I3,4X," FAIL  ",32X,A31)                           08290909
80010 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",15X,"COMPUTED= " ,           08300909
     1I6,/," ",15X,"CORRECT=  " ,I6)                                    08310909
80012 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           08320909
     1E12.5,/," ",16X,"CORRECT=  " ,E12.5)                              08330909
80018 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           08340909
     1A21,/," ",16X,"CORRECT=  " ,A21)                                  08350909
80020 FORMAT (" ",16X,"COMPUTED= " ,A21,1X,A31)                         08360909
80022 FORMAT (" ",16X,"CORRECT=  " ,A21,1X,A31)                         08370909
80024 FORMAT (" ",16X,"COMPUTED= " ,I6,16X,A31)                         08380909
80026 FORMAT (" ",16X,"CORRECT=  " ,I6,16X,A31)                         08390909
80028 FORMAT (" ",16X,"COMPUTED= " ,E12.5,10X,A31)                      08400909
80030 FORMAT (" ",16X,"CORRECT=  " ,E12.5,10X,A31)                      08410909
80050 FORMAT (" ",48X,A31)                                              08420909
CBE** ********************** BBCFMT0A **********************************08430909
CBB** ********************** BBCFMAT1 **********************************08440909
C**** FORMATS FOR TEST DETAIL LINES - FULL LANGUAGE                     08450909
C****                                                                   08460909
80031 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           08470909
     1D17.10,/," ",16X,"CORRECT=  " ,D17.10)                            08480909
80033 FORMAT (" ",16X,"COMPUTED= " ,D17.10,10X,A31)                     08490909
80035 FORMAT (" ",16X,"CORRECT=  " ,D17.10,10X,A31)                     08500909
80037 FORMAT (" ",16X,"COMPUTED= " ,"(",E12.5,", ",E12.5,")",6X,A31)    08510909
80039 FORMAT (" ",16X,"CORRECT=  " ,"(",E12.5,", ",E12.5,")",6X,A31)    08520909
80041 FORMAT (" ",16X,"COMPUTED= " ,"(",F12.5,", ",F12.5,")",6X,A31)    08530909
80043 FORMAT (" ",16X,"CORRECT=  " ,"(",F12.5,", ",F12.5,")",6X,A31)    08540909
80045 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           08550909
     1"(",F12.5,", ",F12.5,")"/," ",16X,"CORRECT=  " ,                  08560909
     2"(",F12.5,", ",F12.5,")")                                         08570909
CBE** ********************** BBCFMAT1 **********************************08580909
CBB** ********************** BBCFMT0B **********************************08590909
C**** FORMAT STATEMENTS FOR PAGE HEADERS                                08600909
C****                                                                   08610909
90002 FORMAT ("1")                                                      08620909
90004 FORMAT (" ")                                                      08630909
90006 FORMAT (" ",20X,"NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY" )08640909
90007 FORMAT (" ",19X,"FORTRAN COMPILER VALIDATION SYSTEM" )            08650909
90008 FORMAT (" ",21X,A13,A17)                                          08660909
90009 FORMAT (" ",/," *",A5,"BEGIN*",12X,"TEST RESULTS - " ,A5,/)       08670909
90010 FORMAT (" ",8X,"TEST DATE*TIME= " ,A17,"  -  COMPILER= " ,A20)    08680909
90013 FORMAT (" "," TEST   ","PASS/FAIL " ,6X,"DISPLAYED RESULTS" ,     08690909
     1       7X,"REMARKS",24X)                                          08700909
90014 FORMAT (" ","----------------------------------------------" ,    08710909
     1        "---------------------------------" )                     08720909
90015 FORMAT (" ",48X,"THIS PROGRAM HAS " ,I3," TESTS",/)               08730909
C****                                                                   08740909
C**** FORMAT STATEMENTS FOR REPORT FOOTINGS                             08750909
C****                                                                   08760909
90016 FORMAT (" ",/," *",A5,"END*",14X,"END OF TEST - " ,A5,/)          08770909
90018 FORMAT (" ",A13,13X,A20,"   *   ",A10,"/",                        08780909
     1        A13)                                                      08790909
90019 FORMAT (" ","FOR OFFICIAL USE ONLY     " ,35X,"COPYRIGHT  1982" ) 08800909
C****                                                                   08810909
C**** FORMAT STATEMENTS FOR RUN SUMMARY                                 08820909
C****                                                                   08830909
90020 FORMAT (" ",21X,I5," TESTS PASSED" )                              08840909
90022 FORMAT (" ",21X,I5," TESTS FAILED" )                              08850909
90024 FORMAT (" ",21X,I5," TESTS DELETED" )                             08860909
90026 FORMAT (" ",21X,I5," TESTS REQUIRE INSPECTION" )                  08870909
90028 FORMAT (" ",21X,I5," OF ",I3," TESTS EXECUTED" )                  08880909
