...
43100   FORMAT(" ", / " INQU2 - (431) INQUIRE BY UNIT" //               01150915
     1         " SEQUENTIAL UNFORMATTED FILE, CONNECTED BY OPEN" //     01160915
     2         " ANS REF. - 12.10.3" )                                  01170915
...
20015      FORMAT (" ",2X,I3,4X," FAIL",12X,                            01500915
     1     "ERROR IN EXECUTION OF INQUIRE STATEMENT (ERR=)" /)          01510915
           GO TO 20016                                                  01520915
20010      CONTINUE                                                     01530915
           WRITE (NUVI, 20011) IVTNUM                                   01540915
20011      FORMAT(" ",2X,I3,4X," FAIL",12X,                             01550915
     1     "ERROR IN AN INQUIRE SPECIFIER" /)                           01560915
20016      IVFAIL = IVFAIL + 1                                          01570915
           WRITE (NUVI, 20012) KVI,AVB,BVB,JVI,B10VK,C10VK,E11VK,       01580915
     1                         G10VK                                    01590915
20012      FORMAT (" ",16X,"COMPUTED: " ,"IOSTAT=",I1,", EXIST=",L1,    01600915
     1             " ,OPENED=",L1,", NUMBER=",I4,","/                   01610915
     2             " ",26X,"ACCESS=",A10,", SEQUENTIAL=" ,A3,", FORM=", 01620915
     3             A11,","/" ",26X,"UNFORMATTED=" ,A3)                  01630915
           WRITE (NUVI, 20013) IMVI                                     01640915
20013      FORMAT (" ",16X,"CORRECT:  " ,"IOSTAT=0, EXIST=T, " ,        01650915
     1             "OPENED=T, NUMBER=" ,I4,","/                         01660915
     2             " ",26X,"ACCESS=SEQUENTIAL, SEQUENTIAL=YES, FORM=" , 01670915
     3             "UNFORMATTED," /" ",26X,"UNFORMATTED=YES" )          01680915
...
20025      FORMAT (" ",2X,I3,4X," FAIL",12X,                            01930915
     1     "ERROR IN EXECUTION OF INQUIRE STATEMENT (ERR=)" /)          01940915
           GO TO 20026                                                  01950915
20020      CONTINUE                                                     01960915
           WRITE (NUVI, 20021) IVTNUM                                   01970915
20021      FORMAT(" ",2X,I3,4X," FAIL",12X,                             01980915
     1     "ERROR IN AN INQUIRE SPECIFIER" /)                           01990915
20026      IVFAIL = IVFAIL + 1                                          02000915
           WRITE (NUVI, 20022) KVI,AVB,BVB,JVI,B10VK,C10VK,E11VK,       02010915
     1                         G10VK                                    02020915
20022      FORMAT (" ",16X,"COMPUTED: " ,"IOSTAT=",I1,", EXIST=",L1,    02030915
     1             " ,OPENED=",L1,", NUMBER=",I4,","/                   02040915
     2             " ",26X,"ACCESS=",A10,", SEQUENTIAL=" ,A3,", FORM=", 02050915
     3             A11,","/" ",26X,"UNFORMATTED=" ,A3)                  02060915
           WRITE (NUVI, 20023) IMVI                                     02070915
20023      FORMAT (" ",16X,"CORRECT:  " ,"IOSTAT=0, EXIST=T, " ,        02080915
     1             "OPENED=T, NUMBER=" ,I4,","/                         02090915
     2             " ",26X,"ACCESS=SEQUENTIAL, SEQUENTIAL=YES, FORM=" , 02100915
     3             "UNFORMATTED," /" ",26X,"UNFORMATTED=YES" )          02110915
...
20035      FORMAT (" ",2X,I3,4X," FAIL",12X,                            02380915
     1     "ERROR IN EXECUTION OF INQUIRE STATEMENT (ERR=)" /)          02390915
           GO TO 20036                                                  02400915
20030      CONTINUE                                                     02410915
           WRITE (NUVI, 20031) IVTNUM                                   02420915
20031      FORMAT(" ",2X,I3,4X," FAIL",12X,                             02430915
     1     "ERROR IN AN INQUIRE SPECIFIER" /)                           02440915
20036      IVFAIL = IVFAIL + 1                                          02450915
           WRITE (NUVI, 20032) KVI,AVB,BVB,JVI,B10VK,C10VK,E11VK,       02460915
     1                         G10VK                                    02470915
20032      FORMAT (" ",16X,"COMPUTED: " ,"IOSTAT=",I1,", EXIST=",L1,    02480915
     1             " ,OPENED=",L1,", NUMBER=",I4,","/                   02490915
     2             " ",26X,"ACCESS=",A10,", SEQUENTIAL=" ,A3,", FORM=", 02500915
     3             A11,","/" ",26X,"UNFORMATTED=" ,A3)                  02510915
           WRITE (NUVI, 20033) IMVI                                     02520915
20033      FORMAT (" ",16X,"CORRECT:  " ,"IOSTAT=0, EXIST=T, " ,        02530915
     1             "OPENED=T, NUMBER=" ,I4,","/                         02540915
     2             " ",26X,"ACCESS=SEQUENTIAL, SEQUENTIAL=YES, FORM=" , 02550915
     3             "UNFORMATTED," /" ",26X,"UNFORMATTED=YES" )          02560915
...
C****                                                                   02820915
80000 FORMAT (" ",2X,I3,4X,"DELETED",32X,A31)                           02830915
80002 FORMAT (" ",2X,I3,4X," PASS  ",32X,A31)                           02840915
80004 FORMAT (" ",2X,I3,4X,"INSPECT",32X,A31)                           02850915
80008 FORMAT (" ",2X,I3,4X," FAIL  ",32X,A31)                           02860915
80010 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",15X,"COMPUTED= " ,           02870915
     1I6,/," ",15X,"CORRECT=  " ,I6)                                    02880915
80012 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           02890915
     1E12.5,/," ",16X,"CORRECT=  " ,E12.5)                              02900915
80018 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           02910915
     1A21,/," ",16X,"CORRECT=  " ,A21)                                  02920915
80020 FORMAT (" ",16X,"COMPUTED= " ,A21,1X,A31)                         02930915
80022 FORMAT (" ",16X,"CORRECT=  " ,A21,1X,A31)                         02940915
80024 FORMAT (" ",16X,"COMPUTED= " ,I6,16X,A31)                         02950915
80026 FORMAT (" ",16X,"CORRECT=  " ,I6,16X,A31)                         02960915
80028 FORMAT (" ",16X,"COMPUTED= " ,E12.5,10X,A31)                      02970915
80030 FORMAT (" ",16X,"CORRECT=  " ,E12.5,10X,A31)                      02980915
80050 FORMAT (" ",48X,A31)                                              02990915
CBE** ********************** BBCFMT0A **********************************03000915
CBB** ********************** BBCFMAT1 **********************************03010915
C**** FORMATS FOR TEST DETAIL LINES - FULL LANGUAGE                     03020915
C****                                                                   03030915
80031 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           03040915
     1D17.10,/," ",16X,"CORRECT=  " ,D17.10)                            03050915
80033 FORMAT (" ",16X,"COMPUTED= " ,D17.10,10X,A31)                     03060915
80035 FORMAT (" ",16X,"CORRECT=  " ,D17.10,10X,A31)                     03070915
80037 FORMAT (" ",16X,"COMPUTED= " ,"(",E12.5,", ",E12.5,")",6X,A31)    03080915
80039 FORMAT (" ",16X,"CORRECT=  " ,"(",E12.5,", ",E12.5,")",6X,A31)    03090915
80041 FORMAT (" ",16X,"COMPUTED= " ,"(",F12.5,", ",F12.5,")",6X,A31)    03100915
80043 FORMAT (" ",16X,"CORRECT=  " ,"(",F12.5,", ",F12.5,")",6X,A31)    03110915
80045 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           03120915
     1"(",F12.5,", ",F12.5,")"/," ",16X,"CORRECT=  " ,                  03130915
     2"(",F12.5,", ",F12.5,")")                                         03140915
CBE** ********************** BBCFMAT1 **********************************03150915
CBB** ********************** BBCFMT0B **********************************03160915
C**** FORMAT STATEMENTS FOR PAGE HEADERS                                03170915
C****                                                                   03180915
90002 FORMAT ("1")                                                      03190915
90004 FORMAT (" ")                                                      03200915
90006 FORMAT (" ",20X,"NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY" )03210915
90007 FORMAT (" ",19X,"FORTRAN COMPILER VALIDATION SYSTEM" )            03220915
90008 FORMAT (" ",21X,A13,A17)                                          03230915
90009 FORMAT (" ",/," *",A5,"BEGIN*",12X,"TEST RESULTS - " ,A5,/)       03240915
90010 FORMAT (" ",8X,"TEST DATE*TIME= " ,A17,"  -  COMPILER= " ,A20)    03250915
90013 FORMAT (" "," TEST   ","PASS/FAIL " ,6X,"DISPLAYED RESULTS" ,     03260915
     1       7X,"REMARKS",24X)                                          03270915
90014 FORMAT (" ","----------------------------------------------" ,    03280915
     1        "---------------------------------" )                     03290915
90015 FORMAT (" ",48X,"THIS PROGRAM HAS " ,I3," TESTS",/)               03300915
C****                                                                   03310915
C**** FORMAT STATEMENTS FOR REPORT FOOTINGS                             03320915
C****                                                                   03330915
90016 FORMAT (" ",/," *",A5,"END*",14X,"END OF TEST - " ,A5,/)          03340915
90018 FORMAT (" ",A13,13X,A20,"   *   ",A10,"/",                        03350915
     1        A13)                                                      03360915
90019 FORMAT (" ","FOR OFFICIAL USE ONLY     " ,35X,"COPYRIGHT  1982" ) 03370915
C****                                                                   03380915
C**** FORMAT STATEMENTS FOR RUN SUMMARY                                 03390915
C****                                                                   03400915
90020 FORMAT (" ",21X,I5," TESTS PASSED" )                              03410915
90022 FORMAT (" ",21X,I5," TESTS FAILED" )                              03420915
90024 FORMAT (" ",21X,I5," TESTS DELETED" )                             03430915
90026 FORMAT (" ",21X,I5," TESTS REQUIRE INSPECTION" )                  03440915
90028 FORMAT (" ",21X,I5," OF ",I3," TESTS EXECUTED" )                  03450915
