...
16101   FORMAT(" ", //  2X,"XSIGN - (161) INTRINSIC FUNCTIONS-- " //12X,00940359
     1           "SIGN, ISIGN (TRANSFER OF SIGN)" //                    00950359
     2           2X,"SUBSET REF. - 15.3 " )                             00960359
...
16102   FORMAT (/ 8X, "TEST OF SIGN" )                                  01100359
...
16104   FORMAT (/ 8X, "TEST OF ISIGN" )                                 02680359
C*****                                                                  02690359
...
C****                                                                   04360359
80000 FORMAT (" ",2X,I3,4X,"DELETED",32X,A31)                           04370359
80002 FORMAT (" ",2X,I3,4X," PASS  ",32X,A31)                           04380359
80004 FORMAT (" ",2X,I3,4X,"INSPECT",32X,A31)                           04390359
80008 FORMAT (" ",2X,I3,4X," FAIL  ",32X,A31)                           04400359
80010 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",15X,"COMPUTED= " ,           04410359
     1I6,/," ",15X,"CORRECT=  " ,I6)                                    04420359
80012 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           04430359
     1E12.5,/," ",16X,"CORRECT=  " ,E12.5)                              04440359
80018 FORMAT (" ",2X,I3,4X," FAIL  ",/," ",16X,"COMPUTED= " ,           04450359
     1A21,/," ",16X,"CORRECT=  " ,A21)                                  04460359
80020 FORMAT (" ",16X,"COMPUTED= " ,A21,1X,A31)                         04470359
80022 FORMAT (" ",16X,"CORRECT=  " ,A21,1X,A31)                         04480359
80024 FORMAT (" ",16X,"COMPUTED= " ,I6,16X,A31)                         04490359
80026 FORMAT (" ",16X,"CORRECT=  " ,I6,16X,A31)                         04500359
80028 FORMAT (" ",16X,"COMPUTED= " ,E12.5,10X,A31)                      04510359
80030 FORMAT (" ",16X,"CORRECT=  " ,E12.5,10X,A31)                      04520359
80050 FORMAT (" ",48X,A31)                                              04530359
CBE** ********************** BBCFMT0A **********************************04540359
CBB** ********************** BBCFMT0B **********************************04550359
C**** FORMAT STATEMENTS FOR PAGE HEADERS                                04560359
C****                                                                   04570359
90002 FORMAT ("1")                                                      04580359
90004 FORMAT (" ")                                                      04590359
90006 FORMAT (" ",20X,"NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY" )04600359
90007 FORMAT (" ",19X,"FORTRAN COMPILER VALIDATION SYSTEM" )            04610359
90008 FORMAT (" ",21X,A13,A17)                                          04620359
90009 FORMAT (" ",/," *",A5,"BEGIN*",12X,"TEST RESULTS - " ,A5,/)       04630359
90010 FORMAT (" ",8X,"TEST DATE*TIME= " ,A17,"  -  COMPILER= " ,A20)    04640359
90013 FORMAT (" "," TEST   ","PASS/FAIL " ,6X,"DISPLAYED RESULTS" ,     04650359
     1       7X,"REMARKS",24X)                                          04660359
90014 FORMAT (" ","----------------------------------------------" ,    04670359
     1        "---------------------------------" )                     04680359
90015 FORMAT (" ",48X,"THIS PROGRAM HAS " ,I3," TESTS",/)               04690359
C****                                                                   04700359
C**** FORMAT STATEMENTS FOR REPORT FOOTINGS                             04710359
C****                                                                   04720359
90016 FORMAT (" ",/," *",A5,"END*",14X,"END OF TEST - " ,A5,/)          04730359
90018 FORMAT (" ",A13,13X,A20,"   *   ",A10,"/",                        04740359
     1        A13)                                                      04750359
90019 FORMAT (" ","FOR OFFICIAL USE ONLY     " ,35X,"COPYRIGHT  1982" ) 04760359
C****                                                                   04770359
C**** FORMAT STATEMENTS FOR RUN SUMMARY                                 04780359
C****                                                                   04790359
90020 FORMAT (" ",21X,I5," TESTS PASSED" )                              04800359
90022 FORMAT (" ",21X,I5," TESTS FAILED" )                              04810359
90024 FORMAT (" ",21X,I5," TESTS DELETED" )                             04820359
90026 FORMAT (" ",21X,I5," TESTS REQUIRE INSPECTION" )                  04830359
90028 FORMAT (" ",21X,I5," OF ",I3," TESTS EXECUTED" )                  04840359
